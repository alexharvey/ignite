 ...
 *
 */
class Authenticated extends Admin_Controller
{
    protected $permissionCreate = 'Sales.Authenticated.Create';
    protected $permissionDelete = 'Sales.Authenticated.Delete';
    protected $permissionEdit   = 'Sales.Authenticated.Edit';
    protected $permissionView   = 'Sales.Authenticated.View';
	...
	public function create()
	{
		...
		if (isset($_POST['save'])) {
			if ($insert_id = $this->save_sales()) {
				...
				redirect(site_url('//authenticated/sales'));
			}
	...
	public function edit()
	{
		...
		if (isset($_POST['save'])) {
			...
			if ($this->save_sales('update', $id)) {
				...
				redirect(site_url('/admin/authenticated/sales'));
			}
