...
$num_columns	= 4;
$can_delete	= $this->auth->has_permission('Sales.Authenticated.Delete');
$can_edit		= $this->auth->has_permission('Sales.Authenticated.Edit');
	...
	<div class='col-md-12'>
		<div class='box'>
			<div class='box-header'>
				...
				<div class='box-tools'>
					<?php if ($can_edit) : ?>
					<a href='<?php echo site_url('/authenticated/sales/create'); ?>' class='btn btn-success btn-sm'>Add</a>
					<?php endif; ?>
				</div>
			</div>
			<div class='box-body'>
				...
				?>
							<tr>
								...
								<?php endif;?> 
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(site_url('/authenticated/sales/edit/' . $record->id), '<span class="icon-pencil"></span> ' .  $record->name); ?></td>
				<?php else : ?>
